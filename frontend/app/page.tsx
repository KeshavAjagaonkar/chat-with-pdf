...
export default function LandingPage() {
  ...
  // Use cases matching targeted personas (User-Centric)
  const useCases = [
    {
      ...
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-emerald-400" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.8}>
  ...
  return (
    <main className="min-h-screen bg-[#030303] bg-grid-pattern text-neutral-300 flex flex-col relative selection:bg-emerald-500/20 selection:text-emerald-300 overflow-x-hidden">
      
      {/* Dynamic Glowing Ambient Blobs */}
      <div className="absolute top-0 left-1/4 w-[600px] h-[350px] bg-emerald-500/5 rounded-full blur-[130px] pointer-events-none z-0" />
      <div className="absolute top-1/3 right-1/4 w-[450px] h-[450px] bg-teal-500/5 rounded-full blur-[140px] pointer-events-none z-0" />
      <div className="absolute bottom-1/4 left-1/3 w-[500px] h-[350px] bg-emerald-600/5 rounded-full blur-[120px] pointer-events-none z-0" />
      ...
      <nav className="sticky top-0 z-50 backdrop-blur-md bg-[#030303]/75 border-b border-neutral-900/60 px-6 md:px-12 py-4 flex items-center justify-between shrink-0 transition-all duration-300">
        ...
        <div className="flex items-center gap-3">
          ...
          <a
            href="/sign-up"
            className="text-xs bg-emerald-500 hover:bg-emerald-400 text-neutral-950 font-bold px-4.5 py-2.5 rounded-lg transition-all duration-300 shadow-md shadow-emerald-500/10 hover:shadow-emerald-500/35 transform hover:scale-[1.01]"
          >
            Get Started
          </a>
        </div>
      ...
      <section className="flex flex-col items-center text-center px-6 pt-16 pb-12 md:pt-24 md:pb-16 max-w-4xl mx-auto shrink-0 relative z-10">
        ...
        <div className="inline-flex items-center gap-2 bg-emerald-950/40 text-emerald-400 text-[10px] uppercase tracking-widest font-bold px-3.5 py-1.5 rounded-full mb-6 border border-emerald-900/30">
        ...
        {/* User-Centric CTA area */}
        <div className="flex flex-col sm:flex-row items-center gap-4 mt-10 w-full sm:w-auto">
          
          {/* Custom Ingest redirect button */}
          <button
            onClick={() => router.push("/sign-up")}
            className="w-full sm:w-auto bg-emerald-500 hover:bg-emerald-400 text-neutral-950 font-bold px-8 py-3.5 rounded-xl transition-all duration-300 text-xs uppercase tracking-wider shadow-lg shadow-emerald-500/15 hover:shadow-emerald-500/35 transform hover:scale-[1.02]"
          >
            Upload a PDF Now →
          </button>
          ...
          <a
            href="/sign-in"
            className="w-full sm:w-auto border border-neutral-800 text-neutral-400 hover:text-neutral-100 hover:bg-neutral-900/40 font-bold px-6 py-3.5 rounded-xl transition duration-300 text-xs uppercase tracking-wider"
          >
            Access Dashboard
          </a>
        </div>
      ...
      <section className="px-6 md:px-12 pb-20 max-w-5xl mx-auto w-full shrink-0 relative z-10">
        <div className="bg-neutral-950/50 border border-neutral-900 rounded-2xl p-2 md:p-3 shadow-[0_0_80px_rgba(16,185,129,0.02)] relative group hover:border-neutral-800/60 transition duration-500">
          ...
          <div className="grid md:grid-cols-5 gap-3 h-[420px] rounded-xl overflow-hidden text-xs">
            ...
            <div className="hidden md:flex md:col-span-2 bg-[#090909] border border-neutral-900/60 rounded-lg p-4 flex-col gap-4 overflow-hidden relative">
                ...
                <div className="flex gap-2.5 max-w-[90%] shrink-0">
                  ...
                  <div className="flex flex-col gap-2">
                    ...
                    <div className="flex items-center gap-1.5 mt-1">
                      <span className="text-[10px] bg-emerald-950/60 text-emerald-400 px-2 py-0.5 rounded border border-emerald-900/30 font-medium">
      ...
      {/* Targeted Audience Use Cases (Highly User-Centric) */}
      <section className="px-6 md:px-12 py-16 md:py-24 max-w-6xl mx-auto relative z-10 border-t border-neutral-900/60 w-full shrink-0">
        
        <div className="text-center max-w-2xl mx-auto mb-16">
          <h2 className="text-xs font-bold text-emerald-400 uppercase tracking-widest mb-3">Tailored Use Cases</h2>
        ...
        <div className="grid lg:grid-cols-3 gap-8">
          {useCases.map((uc, i) => (
            <div
              key={i}
              className="bg-neutral-950/40 border border-neutral-900 rounded-2xl p-6 hover:border-emerald-500/20 hover:bg-neutral-950/70 transition-all duration-300 flex flex-col justify-between group transform hover:scale-[1.005]"
            >
              <div>
                <div className="flex items-center justify-between mb-4 pb-3 border-b border-neutral-900/40">
                  <div className="flex items-center gap-2.5">
                    <div className="w-8.5 h-8.5 bg-emerald-950/40 border border-emerald-900/20 text-emerald-400 rounded-xl flex items-center justify-center shrink-0 group-hover:scale-105 transition-all duration-300">
                      {uc.icon}
                    </div>
                    <span className="text-xs font-bold text-neutral-200 uppercase tracking-tight">{uc.category}</span>
                  </div>
                  <span className="text-[9px] bg-emerald-950/40 text-emerald-400 px-2 py-0.5 rounded-full border border-emerald-900/20 font-bold uppercase tracking-wider">
                    {uc.badge}
                  </span>
                </div>
              ...
              <div className="bg-neutral-900/20 border border-neutral-900/60 rounded-xl p-3.5 mt-auto">
      ...
      <section className="px-6 md:px-12 py-16 md:py-24 max-w-4xl mx-auto relative z-10 border-t border-neutral-900/60 w-full shrink-0">
        <div className="text-center max-w-2xl mx-auto mb-16">
          <h2 className="text-xs font-bold text-emerald-400 uppercase tracking-widest mb-3">Vector Architecture</h2>
          <p className="text-2xl md:text-3xl font-black tracking-tight text-neutral-100 leading-tight">
            How our ingestion engine works
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-6 relative">
          ...
          {/* Step 1 */}
          <div className="bg-neutral-950/20 border border-neutral-900 rounded-xl p-5 relative overflow-hidden flex flex-col gap-3">
            <span className="text-[10px] bg-neutral-900 text-neutral-500 font-mono w-6 h-6 rounded-md flex items-center justify-center shrink-0 font-bold">01</span>
          ...
          {/* Step 2 */}
          <div className="bg-neutral-950/20 border border-neutral-900 rounded-xl p-5 relative overflow-hidden flex flex-col gap-3">
            <span className="text-[10px] bg-neutral-900 text-neutral-500 font-mono w-6 h-6 rounded-md flex items-center justify-center shrink-0 font-bold">02</span>
          ...
          {/* Step 3 */}
          <div className="bg-neutral-950/20 border border-neutral-900 rounded-xl p-5 relative overflow-hidden flex flex-col gap-3">
            <span className="text-[10px] bg-neutral-900 text-neutral-500 font-mono w-6 h-6 rounded-md flex items-center justify-center shrink-0 font-bold">03</span>
      ...
      <section className="px-6 md:px-12 py-16 md:py-24 max-w-3xl mx-auto relative z-10 border-t border-neutral-900/60 w-full shrink-0">
        
        <div className="text-center max-w-xl mx-auto mb-16">
          <h2 className="text-xs font-bold text-emerald-400 uppercase tracking-widest mb-3">Common Questions</h2>
          <p className="text-2xl md:text-3xl font-black tracking-tight text-neutral-100 leading-tight">
        ...
        <div className="flex flex-col gap-3">
          {faqs.map((faq, idx) => {
            ...
            return (
              <div
                key={idx}
                className="bg-neutral-950/40 border border-neutral-900 rounded-xl overflow-hidden transition-all duration-300"
              >
                {/* FAQ Question button */}
                <button
                  onClick={() => setOpenFaq(isOpen ? null : idx)}
                  className="w-full text-left px-5 py-4 flex items-center justify-between text-xs font-bold text-neutral-200 tracking-tight uppercase hover:text-neutral-100 transition select-none outline-none focus:text-emerald-400"
                >
                  <span>{faq.q}</span>
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    className={`h-4.5 w-4.5 text-neutral-600 transition-transform duration-300 ${isOpen ? "rotate-180 text-emerald-400" : ""}`}
                    fill="none"
                    viewBox="0 0 24 24"
                    stroke="currentColor"
                    strokeWidth={2}
                ...
                <div
                  className={`transition-all duration-300 ease-in-out ${
                    isOpen ? "max-h-40 border-t border-neutral-900/60 opacity-100" : "max-h-0 opacity-0 pointer-events-none"
                  }`}
                >
      ...
      {/* Bottom Sticky Signup Prompt Section */}
      <section className="px-6 md:px-12 py-16 md:py-24 text-center relative z-10 border-t border-neutral-900/60 max-w-4xl mx-auto w-full shrink-0">
        ...
        <div className="mt-8">
          <button
            onClick={() => router.push("/sign-up")}
            className="bg-emerald-500 hover:bg-emerald-400 text-neutral-950 font-bold px-8 py-3.5 rounded-xl transition-all duration-300 text-xs uppercase tracking-wider shadow-lg shadow-emerald-500/10 hover:shadow-emerald-500/30 transform hover:scale-[1.02]"
          >
            Create Free Account
          </button>
        </div>
      ...
      {/* Footer */}
      <footer className="border-t border-neutral-900/60 px-6 py-8 text-center shrink-0 bg-[#030303]/60 relative z-10">
